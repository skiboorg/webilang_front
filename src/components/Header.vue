...
<!--          </p>-->
    ...
    <div class="header-bottom gt-sm">
      <div class="header-bottom__inner flex items-center justify-between">
        ...
        <div class="flex items-center">
          <img class="q-mr-md flag" :src="localeOptions.find(x=>x.value===locale).img" alt="">
          <q-select
          v-model="locale"
 ...
 <q-btn :to="$auth.loggedIn ?
    ...
    <div class="q-px-md q-mb-lg flex items-center">
        <img class="q-mr-md flag" :src="localeOptions.find(x=>x.value===locale).img" alt="">
      <q-select
        v-model="locale"
        :options="localeOptions"
...
export default {
  ...
  data(){
    return{
      ...
      localeOptions: [
        { value: 'en-US', label: 'English', img:'/en_f.jpg' },
        { value: 'ru', label: 'Русский', img:'/ru_f.jpg' }
      ],
...
.flag
  border-radius: 100%
  filter: drop-shadow(2px 2px 3px $grey-6)
</style>
