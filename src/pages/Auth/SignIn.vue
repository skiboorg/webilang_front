...
<!--        </div>-->
<!--        <p class="no-margin" v-html="$t('apple_login')"></p>-->
<!--      </div>-->
      <div v-if="!is_password_recover" class="social-button facebook" @click="fbLogin">
        <div class="social-button__icon">
        ...
        <p class="no-margin" v-html="$t('facebook_login')"></p>
      </div>
      <div v-if="!is_password_recover" class="social-button vk" @click="vkLogin">
        <div class="social-button__icon">
        ...
        <p class="no-margin" v-html="$t('vk_login')"></p>
      </div>
    </div>
  </q-page>
</template>
...
export default {
  ...
  methods:{
    ...
    userLoginAction() {
      ...
      this.userLogin.email = this.userInput.email.toLowerCase()
