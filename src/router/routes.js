...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'rules',name:'front-rules', component: () => import('pages/FrontPages/Rules.vue') },
    ]
  },
  {
    path: '/student',
    ...
    children: [
      ...
      {path: 'payment_complete', name: 'student-payment_complete',meta:{title:'side_bar_menu_payment'}, component: () => import('pages/Student/PaymentComplete')},
      {path: 'payment_fail', name: 'student-payment_fail',meta:{title:'side_bar_menu_payment'}, component: () => import('pages/Student/PaymentFail')},
